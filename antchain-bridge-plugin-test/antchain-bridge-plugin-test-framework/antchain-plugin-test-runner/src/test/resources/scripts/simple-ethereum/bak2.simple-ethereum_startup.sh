...
# nohup geth --datadir datadir --dev --ws --rpc --rpccorsdomain https://remix.ethereum.org --wsaddr "0.0.0.0" --rpcaddr "0.0.0.0"
# --rpcport 8545 --wsport 8546 --port 30303 --rpcapi eth,web3,personal,net,miner,admin,debug --allow-insecure-unlock
# >/dev/null 2>&1 &
