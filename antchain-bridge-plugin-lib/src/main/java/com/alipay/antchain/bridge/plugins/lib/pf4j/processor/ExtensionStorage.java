...
/**
 * It's a storage (database) that persists {@link BBCService}s.
 * The standard operations supported by storage are {@link #read} and {@link #write}.
 * The storage is populated by {@link BBCServiceAnnotationProcessor}.
 *
 * <p>
 * We modify the code from {@link org.pf4j.processor.ExtensionStorage} to satisfy our needs.
 * </p>
 */
public abstract class ExtensionStorage {
    ...
    protected final BBCServiceAnnotationProcessor processor;

    public ExtensionStorage(BBCServiceAnnotationProcessor processor) {
