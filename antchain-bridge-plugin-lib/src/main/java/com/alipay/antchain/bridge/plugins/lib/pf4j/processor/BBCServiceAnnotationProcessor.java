 ...
 * </p>
 */
public class BBCServiceAnnotationProcessor extends AbstractProcessor {

    private static final String STORAGE_CLASS_NAME = "antchain.bridge.bbc.storageClassName";
    private static final String IGNORE_EXTENSION_POINT = "antchain.bridge.bbc.ignoreExtensionPoint";
    ...
    public synchronized void init(ProcessingEnvironment processingEnv) {
        ...
        info("%s init", BBCServiceAnnotationProcessor.class.getName());
    ...
    private void initStorage() {
        ...
        if (storageClassName != null) {
            ...
            try {
                ...
                Constructor constructor = storageClass.getConstructor(BBCServiceAnnotationProcessor.class);
