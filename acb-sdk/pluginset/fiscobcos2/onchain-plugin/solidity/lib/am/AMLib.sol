...
library AMLib {
    ...
    function decodeAuthMessage(bytes memory rawMessage) internal returns (AuthMessage memory) {
    ...
    function decodeAuthMessageV1(bytes memory rawMessage) internal returns (AuthMessage memory) {
