...
interface IContractUsingSDP {
     ...
     */
    function recvUnorderedMessage(string memory senderDomain, identity author, bytes memory message) external;
     ...
     * @param message the raw message from sender contract.
     */
    function recvMessage(string memory senderDomain, identity author, bytes memory message) external;
}
