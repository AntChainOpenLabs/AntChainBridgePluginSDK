...
interface IAuthMessage {
    ...
    /**
     * @dev Set the SDP contract identity for verifying the proof come from outside the blockchain.
     * @param protocolAddress upper protocol contract identity
     * @param protocolType type number for upper protocol. for example sdp protocol is zero.
     */
    function setProtocol(identity protocolAddress, uint32 protocolType) external;
     ...
     */
    function recvFromProtocol(identity senderID, bytes memory message) external;
