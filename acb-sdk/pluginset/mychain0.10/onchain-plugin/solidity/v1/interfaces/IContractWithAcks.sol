...
interface IContractWithAcks {
     ...
     */
    function ackOnSuccess(bytes32 messageId, string memory receiverDomain, identity receiver, uint32 sequence, uint64 nonce, bytes memory message) external;
     ...
     */
    function ackOnError(bytes32 messageId, string memory receiverDomain, identity receiver, uint32 sequence, uint64 nonce, bytes memory message, string memory errorMsg) external;
}
