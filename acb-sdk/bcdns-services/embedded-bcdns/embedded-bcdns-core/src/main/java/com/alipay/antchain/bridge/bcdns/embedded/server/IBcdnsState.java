...
public interface IBcdnsState {
    ...
    ThirdPartyBlockchainTrustAnchor queryExactTpBta(CrossChainLane tpbtaLane, long tpbtaVersion);

    ThirdPartyBlockchainTrustAnchor queryMatchedTpBta(CrossChainLane lane);
