...
public enum BCDNSErrorCodeEnum {
    ...
    BCDNS_QUERY_PTCTRUSTROOT_FAILED("8011", "query ptctrustroot failed"),

    BCDNS_SET_PTCTRUSTROOT_FAILED("8012", "set ptctrustroot failed"),

    BCDNS_QUERY_TPBTA_FAILD("8020", "query tpbta failed");
    /**
