...
@Getter
@Setter
public class CrossChainCertificate {
    ...
    public static CrossChainCertificate decode(byte[] rawData) {
        return TLVUtils.decode(rawData, CrossChainCertificate.class);
    }
