...
public interface SDPMsgPoolMapper extends BaseMapper<SDPMsgPoolEntity> {

    void saveSDPMessages(List<SDPMsgWrapper> sdpMsgWrappers);

    int archiveSDPMessages(@Param("idList") List<Long> idList);
}
