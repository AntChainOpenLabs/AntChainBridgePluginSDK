...
@Getter
@Setter
@TableName("domain_cert_application")
public class DomainCertApplicationEntity extends BaseEntity {
    ...
    @TableField("apply_receipt")
    private String applyReceipt;

    @TableField("state")
    private DomainCertApplicationStateEnum state;
}
