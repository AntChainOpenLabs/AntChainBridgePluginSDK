...
interface IAuthMessage {
     ...
     * @param pkgHex hex string for the serialized auth-message.
     */
    event SendAuthMessage(string pkgHex);
     ...
     */
    function recvFromProtocol(address senderID, bytes message) external;
